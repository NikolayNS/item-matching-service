...
public class TransferServiceImpl implements TransferService {
	...
	@Override
	public CompanyTypeResponse addCompanyType(CompanyTypeAddRequest request) {
		return null;
	}
	...
	@Override
	public CompanyTypeResponse updateCompanyType(Long typeId, CompanyTypeUpdateRequest request) {
		return null;
	}
